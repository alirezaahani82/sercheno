...
export default function ElevatorsPage() {
  ...
  /*
   * تصویر اصلی انتخاب‌شده برای هر محصول
   */
            ...
            <div className="mx-auto w-full max-w-7xl px-5 text-white">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-5 text-base leading-8 text-slate-200 sm:text-lg">
                  انواع آسانسور، کابین، موتور،
                  درب آسانسور، تابلو فرمان،
                  ریل، قطعات و تجهیزات تخصصی
                  آسانسور را از فروشندگان و
          ...
          <div className="flex flex-col gap-3 md:flex-row">
            ...
            <div className="flex flex-1 items-center gap-3 rounded-2xl bg-slate-50 px-5 py-4">
              ...
              <input
                ...
                placeholder="مثلاً موتور آسانسور، کابین، درب، ریل..."
      ...
      <section className="mx-auto max-w-7xl px-5 pb-14">
        ...
        <div className="mb-7">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-500">
            ...
            کاربرد، ظرفیت، سیستم حرکتی و محل استفاده
            دسته‌بندی شده‌اند.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="mb-8">
            ...
            <h2 className="mt-2 text-2xl font-black sm:text-3xl">
              محصولات آسانسور و تجهیزات آسانسور
            </h2>

            <p className="mt-3 text-sm text-slate-500">
              تمامی محصولات فعال و تأییدشده این دسته
              به همراه تمام تصاویر ثبت‌شده برای هر محصول
