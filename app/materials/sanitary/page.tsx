        ...
        if (
          ...
          if (imageError) {
            ...
            /*
              ...
              هر تعداد تصویر که برای
              محصول در product_images
              وجود داشته باشد، دریافت می‌شود.
            */
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative h-[420px]">
          ...
          <img
            ...
            alt="لوازم و تجهیزات بهداشتی ساختمان"
            ...
            <div className="mx-auto w-full max-w-7xl px-5 text-white">
              ...
              <div className="max-w-3xl">
                ...
                <span className="inline-block rounded-full bg-white/15 px-4 py-2 text-sm font-bold backdrop-blur">
                  تجهیزات و لوازم بهداشتی ساختمان
                </span>
                ...
                <p className="mt-5 text-base leading-8 text-slate-200 sm:text-lg">
                  انواع لوازم و تجهیزات بهداشتی ساختمان،
                  سرویس‌های بهداشتی، روشویی، توالت،
                  شیرآلات، کابین دوش و تجهیزات وابسته را
                  از فروشندگان و تأمین‌کنندگان معتبر در
                  سرچنو پیدا کنید.
                </p>
          ...
          <div className="flex flex-col gap-3 md:flex-row">
            ...
            <div className="flex flex-1 items-center gap-3 rounded-2xl bg-slate-50 px-5 py-4">
              ...
              <input
                ...
                placeholder="مثلاً روشویی، توالت فرنگی، شیرآلات، کابین دوش..."
      ...
      <section className="mx-auto max-w-7xl px-5 pb-14">
        ...
        <div className="mb-7">
          ...
          <h2 className="mt-2 text-2xl font-black">
            چه نوع تجهیزات بهداشتی نیاز دارید؟
          </h2>

          <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-500">
            محصولات این گروه بر اساس نوع محصول،
            کاربرد، محل استفاده و نوع تجهیزات
            دسته‌بندی شده‌اند.
          </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {[
            ...
            "سینک و تجهیزات وابسته",
            "تجهیزات بهداشتی ویژه",
          ].map(
            (item) => (
              <button
                key={item}
        ...
        <div className="mx-auto max-w-7xl px-5">
          ...
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm text-slate-500">
              تمامی محصولات فعال این دسته که توسط
              تیم سرچنو تأیید شده‌اند در این بخش
              نمایش داده می‌شوند.
            </p>
