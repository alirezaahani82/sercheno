      ...
      <section className="bg-slate-950 text-white">
        <div className="mx-auto max-w-5xl px-6 py-24 text-center">
          ...
          <p className="mx-auto mt-7 max-w-3xl text-lg leading-9 text-slate-300">
            استفاده از پلتفرم سرچینو به معنای پذیرش قوانین و مقررات آن است.
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <p className="mt-5 leading-9 text-slate-600">
                کاربران موظف هستند هنگام استفاده از سرچینو اطلاعات صحیح و
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <p className="mt-5 leading-9 text-slate-600">
                ...
                اطلاعات ثبت‌شده توسط خود هستند. سرچینو بستری برای معرفی و
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <p className="mt-5 leading-9 text-slate-600">
                سرچینو تلاش می‌کند اطلاعات کاربران را در چارچوب قوانین و
...
<div className="flex items-center gap-4">
              ...
              <p className="mt-5 leading-9 text-slate-600">
                ...
                هرگونه محتوایی که حقوق دیگران را نقض کند، در سرچینو ممنوع است.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <p className="mt-5 leading-9 text-slate-600">
                سرچینو می‌تواند در صورت نیاز قوانین و مقررات خود را به‌روزرسانی
