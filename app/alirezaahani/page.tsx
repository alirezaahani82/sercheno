          ...
          <div className="container">
            ...
            <div className="about-grid">
              <div className="about-text">
                ...
                <p>
                  دارای مدرک کارشناسی عمران هستم و در کنار فعالیت‌های
                  حرفه‌ای، در حوزه مدیریت، برنامه‌نویسی، فناوری و هوش
                  مصنوعی نیز فعالیت می‌کنم.
                </p>

                <p>
                  یکی از مهم‌ترین پروژه‌هایی که در این مسیر ایجاد و
                  توسعه داده‌ام، <strong>سرچنو</strong> است؛ یک پلتفرم
                  هوشمند برای صنعت ساخت‌وساز که با هدف ساده‌تر کردن
                  دسترسی به مصالح، فروشندگان، متخصصان و خدمات ساختمانی
                  شکل گرفته است.
                </p>

                <p>
                  نگاه من به کسب‌وکار، ترکیبی از شناخت نیاز بازار،
                  تجربه اجرایی، فناوری، نوآوری و تلاش برای ساختن
                  راهکارهایی است که در دنیای واقعی قابل استفاده باشند.
                </p>
